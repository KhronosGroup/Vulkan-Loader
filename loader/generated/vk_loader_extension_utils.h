...
struct loader_instance_extension_enables {
    int8_t khr_surface : 2;
    int8_t khr_display : 2;
    int8_t khr_xlib_surface : 2;
    int8_t khr_xcb_surface : 2;
    int8_t khr_wayland_surface : 2;
    int8_t khr_win32_surface : 2;
    int8_t khr_get_physical_device_properties2 : 2;
    int8_t khr_device_group_creation : 2;
    int8_t khr_external_memory_capabilities : 2;
    int8_t khr_external_semaphore_capabilities : 2;
    int8_t khr_external_fence_capabilities : 2;
    int8_t khr_get_surface_capabilities2 : 2;
    int8_t khr_get_display_properties2 : 2;
    int8_t khr_surface_protected_capabilities : 2;
    int8_t khr_portability_enumeration : 2;
    int8_t ext_debug_report : 2;
    int8_t ggp_stream_descriptor_surface : 2;
    int8_t nv_external_memory_capabilities : 2;
    int8_t ext_validation_flags : 2;
    int8_t nn_vi_surface : 2;
    int8_t ext_direct_mode_display : 2;
    int8_t ext_acquire_xlib_display : 2;
    int8_t ext_display_surface_counter : 2;
    int8_t ext_swapchain_colorspace : 2;
    int8_t mvk_ios_surface : 2;
    int8_t mvk_macos_surface : 2;
    int8_t ext_debug_utils : 2;
    int8_t fuchsia_imagepipe_surface : 2;
    int8_t ext_metal_surface : 2;
    int8_t ext_validation_features : 2;
    int8_t ext_headless_surface : 2;
    int8_t ext_acquire_drm_display : 2;
    int8_t ext_directfb_surface : 2;
    int8_t qnx_screen_surface : 2;
    int8_t google_surfaceless_query : 2;
};
...
struct loader_device_extension_enables {
    int8_t khr_swapchain : 2;
    int8_t khr_display_swapchain : 2;
    int8_t khr_device_group : 2;
    int8_t ext_debug_marker : 2;
    int8_t ext_debug_utils : 2;
    int8_t ext_full_screen_exclusive : 2;
};
