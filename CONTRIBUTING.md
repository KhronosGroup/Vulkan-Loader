...
Please see the [section about Validation Layers](#special-considerations-for-vulkan-loader)
later on this page.
...
* _Enhancement_:  These issues refer to ideas for extending or improving the loader.
...
* **Commit Messages**
    ...
    * Begin subject line with a one-word component description followed by a colon (e.g. build, docs, loader, etc.)
...
Pull Requests to GitHub are tested in the cloud on Linux and Windows VMs. The Linux VMs use [Travis CI](https://travis-ci.org/KhronosGroup/Vulkan-Loader) with the sequence of commands driven by the [.travis.yml](https://github.com/KhronosGroup/Vulkan-Loader/blob/master/.travis.yml) file. The Windows VMs use [AppVeyor](https://ci.appveyor.com/project/Khronoswebmaster/vulkan-loader/branch/master) with the sequence of commands driven by the [.appveyor.yml](https://github.com/KhronosGroup/Vulkan-Loader/blob/master/.appveyor.yml) file.

#### **Special Considerations for Vulkan Loader**
* **Generated Source Code:** The `loader/generated` directory contains source code that is created by several
...
All contributions made to the Vulkan-Loader repository are Khronos branded and as such,
